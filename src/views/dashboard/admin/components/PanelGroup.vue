    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('messages')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="booksCount" :duration="3000" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('shoppings')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="lateCount" :duration="3600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
  </el-row>
...
import {getCount} from '@/api/echart'
export default {
  components: {
    CountTo
  },
  mounted(){
    this.fetchCount()   //请求数据
  },
  data(){
    return {
      userCount:'',
